...
export const NAVIGATION_FLIGHT_PLANNING_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "A 'great circle' is generally defined as:",
    options: [
      "The line formed where a plane passing through the center of the earth intersects its surface, representing the shortest distance between two points on that sphere",
      "Any line of constant true course drawn on a chart",
      "A line that only exists along the equator",
      "A term describing a circular holding pattern",
    ],
    answer: 0,
    explain:
      "A great circle is formed by a plane that passes through the exact center of the earth, intersecting its surface in a circle whose radius equals the earth's own radius - the shortest possible surface distance between any two points on a sphere lies along the great circle connecting them.",
    reference: "Navigation - Great Circle & Rhumb Line Tracks",
  },
  {
    id: 60,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "A 'rhumb line' is generally defined as:",
    options: [
      "A line that crosses every meridian at the same constant angle, appearing as a straight line on a Mercator projection",
      "The shortest possible distance between two points on a sphere",
      "A line that only exists at the poles",
      "A synonym for a great circle track",
    ],
    answer: 0,
    explain:
      "A rhumb line holds a single, constant true course throughout its length, crossing every meridian it passes at the same angle - this constant-angle property is exactly what makes it appear as a straight line on a Mercator projection, even though it is generally longer than the corresponding great circle route between the same two points.",
    reference: "Navigation - Great Circle & Rhumb Line Tracks",
  },
  {
    id: 61,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On a Mercator chart projection, which of the following is generally true?",
    options: [
      "Rhumb lines appear as straight lines, while great circles (other than along the equator or a meridian) appear as curves",
      "Great circles always appear as straight lines, while rhumb lines appear as curves",
      "Both rhumb lines and great circles always appear as perfectly straight lines",
      "Neither rhumb lines nor great circles can be represented on a Mercator projection",
    ],
    answer: 0,
    explain:
      "A defining property of the Mercator projection is that a rhumb line (constant true course) plots as a straight line, which made it historically valuable for plotting a course to steer - a great circle route, by contrast, generally appears as a curve on this projection (except along the equator or a meridian, where the two coincide).",
    reference: "Navigation - Chart Projections",
  },
  {
    id: 62,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On a Lambert conformal conic chart projection, which of the following is generally true?",
    options: [
      "Great circle routes over the chart's standard parallels appear approximately as straight lines, making it well suited to aeronautical route plotting",
      "Only rhumb lines can ever be plotted on this type of projection",
      "The projection cannot represent any curved lines at all",
      "It is used exclusively for polar navigation and nowhere else",
    ],
    answer: 0,
    explain:
      "A Lambert conformal conic projection is constructed so that great circle routes appear approximately as straight lines over the chart's useful latitude range (near its standard parallels), which is a major reason it is widely used for aeronautical charts covering the mid-latitudes, where following the shortest route is operationally valuable.",
    reference: "Navigation - Chart Projections",
  },
  {
    id: 63,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On an aeronautical chart, an 'isogonic line' connects points of:",
    options: [
      "Equal magnetic variation", "Equal magnetic deviation", "Equal barometric pressure", "Equal terrain elevation",
    ],
    answer: 0,
    explain:
      "Isogonic lines join points sharing the same magnetic variation (the angular difference between true and magnetic north at that location) - a chart feature used for converting between true and magnetic tracks/headings during flight planning.",
    reference: "Navigation - Magnetic Variation Charts",
  },
  {
    id: 64,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "An 'agonic line' on a chart specifically marks the locations where:",
    options: [
      "Magnetic variation is zero (true north and magnetic north coincide)",
      "Magnetic variation is at its maximum possible value",
      "Compass deviation is always zero for every aircraft",
      "Radio navigation coverage is unavailable",
    ],
    answer: 0,
    explain:
      "The agonic line is the specific isogonic line along which magnetic variation is exactly zero - true north and magnetic north point in the same direction at any location along it, meaning true and magnetic tracks/headings are numerically identical there.",
    reference: "Navigation - Magnetic Variation Charts",
  },
  {
    id: 65,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "How is a nautical mile generally defined?",
    options: [
      "Approximately the length of one minute of arc of latitude along a meridian (standardised as 1,852 metres)",
      "Exactly 1,000 metres, identical to a kilometre",
      "The average distance an aircraft travels in one minute at typical cruise speed",
      "A unit used only for measuring altitude, not horizontal distance",
    ],
    answer: 0,
    explain:
      "A nautical mile is based on one minute of arc of latitude measured along a meridian, and has been standardised internationally as exactly 1,852 metres - a natural fit for air and sea navigation, since a distance in nautical miles corresponds directly to an angular distance along a meridian.",
    reference: "Navigation - Nautical Mile Definition",
  },
  {
    id: 66,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "What is the difference between magnetic 'variation' and compass 'deviation'?",
    options: [
      "Variation is the angular difference between true north and magnetic north at a given place, while deviation is the additional angular difference between magnetic north and the direction actually shown by a particular aircraft's compass",
      "Variation and deviation are two different names for exactly the same error",
      "Deviation is caused only by the earth's magnetic field, while variation is caused only by the aircraft's own equipment",
      "Variation changes constantly through the day, while deviation is fixed permanently at the time of manufacture",
    ],
    answer: 0,
    explain:
      "Variation is a location-dependent difference between true north and magnetic north caused by the earth's magnetic field, whereas deviation is an aircraft-specific error caused by magnetic influences local to that airframe (such as electrical equipment) that displaces the compass needle away from magnetic north - true, magnetic, and compass directions therefore differ from one another by variation and then by deviation in turn.",
    reference: "Navigation - Variation & Deviation",
  },
  {
    id: 67,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "What is 'convergency' between two meridians of longitude?",
    options: [
      "The change of direction experienced when travelling along a great circle track (other than a meridian or the equator) as a result of meridians converging toward the poles",
      "The distance between two meridians measured along the equator",
      "A term describing two aircraft converging on the same point at the same time",
      "The angle between a compass needle and the aircraft's nose",
    ],
    answer: 0,
    explain:
      "Because meridians of longitude are not parallel but converge toward the poles, a great circle track (other than one running along a meridian or the equator) continuously changes its true direction as it is followed - this change of direction between two points, resulting from meridian convergence, is called convergency, and it is zero at the equator and greatest near the poles.",
    reference: "Navigation - Convergency",
  },
  {
    id: 68,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "What is a 'conversion angle', and what is it used for?",
    options: [
      "The angular difference in direction between a great circle track and the corresponding rhumb line track joining the same two points, used to convert one direction into the other",
      "The angle used to convert true airspeed into indicated airspeed",
      "The angle between magnetic north and compass north only",
      "A fixed 90-degree correction applied at every waypoint",
    ],
    answer: 0,
    explain:
      "A conversion angle is the angular difference between a great circle track and the rhumb line track connecting the same two points, and is used to convert a great circle direction into an equivalent rhumb line direction (or vice versa) for practical route planning and plotting on charts.",
    reference: "Navigation - Conversion Angle",
  },
  {
    id: 69,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "How is 'departure' - the east-west distance along a parallel of latitude - generally calculated from a change of longitude?",
    options: [
      "Departure (in nautical miles) equals the change of longitude in minutes of arc multiplied by the cosine of the latitude",
      "Departure always equals the change of longitude in minutes of arc with no correction needed",
      "Departure is calculated by multiplying the change of longitude by the aircraft's ground speed",
      "Departure cannot be calculated mathematically and must always be measured directly off a chart",
    ],
    answer: 0,
    explain:
      "Because meridians converge toward the poles, a given change of longitude represents a smaller actual east-west distance the further a parallel of latitude is from the equator; departure - the actual distance in nautical miles - is found by multiplying the change of longitude (in minutes of arc) by the cosine of the latitude, reducing toward zero as latitude approaches 90 degrees.",
    reference: "Navigation - Departure Calculation",
  },
  {
    id: 70,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "What is the basic operating principle of an airborne Doppler navigation system?",
    options: [
      "It is a self-contained onboard radar system that measures the frequency shift of signals reflected off the surface beneath the aircraft to calculate ground speed and drift",
      "It relies entirely on signals transmitted from a network of ground-based navigation beacons",
      "It measures outside air temperature to derive the aircraft's position",
      "It requires a satellite constellation to function, exactly like GPS",
    ],
    answer: 0,
    explain:
      "An airborne Doppler system transmits radar beams toward the surface and measures the frequency shift (Doppler shift) between the transmitted and reflected signals, caused by the aircraft's motion relative to the ground, allowing it to calculate ground speed and drift angle as a completely self-contained system with no need for external ground-based or satellite signals.",
    reference: "Navigation - Doppler Navigation",
  },
  {
    id: 71,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "How does an inertial navigation system (INS) establish true north and magnetic north?",
    options: [
      "True north is established through the alignment of its gyroscopes, and magnetic north is then derived by applying a stored value of magnetic variation to that true reference",
      "Both true north and magnetic north are measured directly by an onboard magnetic compass sensor",
      "True north is transmitted to the system from a ground station before every flight",
      "The system cannot determine true north at all, only magnetic north",
    ],
    answer: 0,
    explain:
      "An inertial navigation system aligns itself to true north using its gyroscopes during the alignment process, and because it has no external magnetic sensor, it derives a magnetic heading reference by applying a magnetic variation value stored in its database to the true heading it has calculated.",
    reference: "Navigation - INS Heading Reference",
  },
  {
    id: 72,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "What distinguishes a 'bounded' inertial navigation system (INS) error from an 'unbounded' one?",
    options: [
      "A bounded error oscillates within limits and returns toward zero over a repeating cycle, whereas an unbounded error, such as one from an incorrect initial position or alignment, continues to grow steadily throughout the flight",
      "A bounded error only ever affects altitude, while an unbounded error only ever affects heading",
      "Bounded errors are always larger in magnitude than unbounded errors",
      "There is no meaningful distinction; all INS errors behave identically over time",
    ],
    answer: 0,
    explain:
      "Some INS errors are self-limiting and cycle back toward zero over a repeating period without growing indefinitely (a bounded error), while other errors - notably from an incorrect initial position entry or a north-alignment error - continue to accumulate steadily as the flight progresses and are not self-correcting (an unbounded error), which is why accurate initial position and alignment are so important.",
    reference: "Navigation - INS Error Behaviour",
  },
  {
    id: 73,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "In broad terms, how is the GPS satellite constellation arranged, and how many satellites are needed for a full three-dimensional position fix?",
    options: [
      "A constellation of at least 24 satellites arranged in multiple orbital planes at high altitude, of which a minimum of four must be in view to provide a full three-dimensional position and time fix",
      "A single geostationary satellite that covers the entire globe at once",
      "Exactly two satellites are always sufficient for any position fix, anywhere on earth",
      "The constellation consists of only ground-based transmitters, with no satellites involved",
    ],
    answer: 0,
    explain:
      "The GPS constellation is designed around a minimum of 24 satellites spread across multiple orbital planes at high altitude so that several are always in view from any point on earth; a receiver needs a minimum of four satellites in view simultaneously to solve for latitude, longitude, altitude, and to resolve its own clock error, giving a full three-dimensional position and time fix.",
    reference: "Navigation - GPS Constellation",
  },
  {
    id: 74,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "What is the general principle behind 'differential' GPS?",
    options: [
      "A ground station at an accurately surveyed location compares its known position with its GPS-derived position and broadcasts a correction factor that nearby aircraft can apply to refine their own GPS position",
      "It uses two separate satellite constellations simultaneously to double the accuracy automatically",
      "It differentially amplifies the GPS signal with no reference to any ground station",
      "It removes the need for any satellites at all",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "Refer to the example SID chart below. You have just departed runway 09 on the PENDA 1A departure. What is the lowest safe altitude at waypoint KADOX?",
    diagram: "/diagrams/fpm-sid-example.svg",
    options: ["5300 ft", "5000 ft", "4157 ft", "FL200"],
    answer: 1,
    explain:
      "KADOX is charted with a minimum crossing restriction of 5000 ft, so that is the lowest altitude permitted there regardless of the aircraft's actual climb performance -- the other figures either belong to a different waypoint on the chart or aren't shown at all.",
    reference: "Flight Planning - Departure (SID) Charts",
  },
  {
    id: 77,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On the same SID chart, according to the charted restriction, what is the highest altitude you may climb to at waypoint PENDA?",
    diagram: "/diagrams/fpm-sid-example.svg",
    options: ["4000 ft", "2000 ft", "6000 ft", "3000 ft"],
    answer: 2,
    explain:
      "PENDA carries a window restriction of MNM 3000 ft / MAX 6000 ft, so 6000 ft is the highest altitude the departure clearance permits at that point -- climbing above it there would bust the charted restriction even if the aircraft could easily climb higher.",
    reference: "Flight Planning - Departure (SID) Charts",
  },
  {
    id: 78,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "Still on the same SID chart, what altitude and radial (to the ZOL VOR) apply at waypoint TARLO?",
    diagram: "/diagrams/fpm-sid-example.svg",
    options: ["A030 - R283", "A040 - R210", "A030 - R103", "A050 - R193"],
    answer: 1,
    explain:
      "TARLO is charted as A040 (a crossing restriction of 4000 ft) on the R210 radial from ZOL, both read directly off the label at that waypoint -- the other options mix in radials and altitudes that belong nowhere on this chart.",
    reference: "Flight Planning - Departure (SID) Charts",
  },
  {
    id: 79,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On the same SID chart, what is the ATIS frequency for Zulu Intl?",
    diagram: "/diagrams/fpm-sid-example.svg",
    options: ["119.500", "121.300", "118.300", "126.925"],
    answer: 3,
    explain:
      "The chart's communications box lists ATIS separately from the approach and tower frequencies -- 126.925 is the ATIS entry, while 119.500/121.300 are the two approach frequencies and 118.300 is the tower frequency.",
    reference: "Flight Planning - Aerodrome Communications",
  },
  {
    id: 80,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "Refer to the example STAR chart below. You are arriving via the TOVAK 1B RNAV arrival and are required to hold at RENGI. What is the Minimum Holding Altitude (MHA)?",
    diagram: "/diagrams/fpm-star-example.svg",
    options: ["FL70", "FL220", "6000 ft", "3000 ft"],
    answer: 2,
    explain:
      "The RENGI hold box on the chart states an MHA of 6000 ft directly -- the FL70-FL90 figures alongside it are the range of levels traffic is expected to be given for the hold itself, not the minimum altitude the hold must be flown no lower than.",
    reference: "Flight Planning - Arrival (STAR) Charts & Holding",
  },
  {
    id: 81,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On the same STAR chart, RENGI is the holding fix. What kind of waypoint is it, and what flight level range is the hold expected to be assigned?",
    diagram: "/diagrams/fpm-star-example.svg",
    options: [
      "(1) Fly-over (non-compulsory) waypoint (2) FL70-FL90",
      "(1) Fly-by (compulsory) RNAV waypoint (2) FL100 only",
      "(1) Fly-by (compulsory) RNAV waypoint (2) FL70-FL90",
      "(1) Fly-over (compulsory) waypoint (2) FL100 only",
    ],
    answer: 2,
    explain:
      "The RENGI hold box labels it as a fly-by, compulsory RNAV waypoint (the aircraft turns early to cut inside the corner rather than flying over the fix and turning after), with an expected hold level range of FL70-FL90 -- both details are read straight off the same box.",
    reference: "Flight Planning - RNAV Waypoint Types",
  },
  {
    id: 82,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "Still on the same STAR chart, what is the MEA (Minimum En-route Altitude) for the segment from RENGI to MOKAB?",
    diagram: "/diagrams/fpm-star-example.svg",
    options: ["12,000 ft", "11,600 ft", "7000 ft", "13,000 ft"],
    answer: 2,
    explain:
      "The RENGI-MOKAB leg is labelled with an MEA of 7000 ft -- the altitude that guarantees both obstacle clearance and reliable navigation signal reception along that specific segment.",
    reference: "Flight Planning - Minimum En-route Altitude",
  },
  {
    id: 83,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On the same STAR chart, what is the MOCA (Minimum Obstacle Clearance Altitude) between waypoints MOKAB and SEDGY?",
    diagram: "/diagrams/fpm-star-example.svg",
    options: ["6200 ft", "FL90", "7000 ft", "4200 ft"],
    answer: 3,
    explain:
      "The MOKAB-SEDGY leg is labelled with a MOCA of 4200 ft. A MOCA guarantees obstacle clearance along that segment but, unlike an MEA, doesn't guarantee reliable navigation signal reception beyond a limited distance from the relevant facility.",
    reference: "Flight Planning - Minimum Obstacle Clearance Altitude",
  },
  {
    id: 84,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "Refer to the example approach chart below. The Maltese cross symbol shown in the profile view identifies:",
    diagram: "/diagrams/fpm-approach-example.svg",
    options: ["Radar capability", "The FAF for a precision approach", "The FAF for a non-precision approach", "ATIS availability"],
    answer: 2,
    explain:
      "A Maltese cross marks the Final Approach Fix on a non-precision approach profile -- a precision approach (such as an ILS) doesn't need a discrete FAF marked this way, since the glideslope itself defines continuous descent guidance from well before that point.",
    reference: "Flight Planning - Approach Chart Symbology",
  },
  {
    id: 85,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On the same approach chart, at what angle does the profile show the aircraft descending toward the runway threshold?",
    diagram: "/diagrams/fpm-approach-example.svg",
    options: ["5.5°", "3.0°", "3.2°", "5.51°"],
    answer: 2,
    explain:
      "The profile view labels the descent path at 3.2° -- close to the typical ~3° glideslope angle used on most instrument approaches, but chart-specific and always worth reading directly rather than assuming a round number.",
    reference: "Flight Planning - Approach Descent Angles",
  },
  {
    id: 86,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "Still on the same approach chart, what is the highest depicted terrain or obstacle spot elevation shown in the plan view?",
    diagram: "/diagrams/fpm-approach-example.svg",
    options: ["842 ft", "956 ft", "1187 ft", "704 ft"],
    answer: 2,
    explain:
      "Of the spot elevations plotted in the plan view, 1187 ft is the highest -- worth identifying specifically, since it's this single highest point (not an average or the nearest one to the airport) that typically drives obstacle-clearance-related altitudes on the chart.",
    reference: "Flight Planning - Terrain & Obstacle Depiction",
  },
  {
    id: 87,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "On the same approach chart, why does the tower frequency box carry a star (★) next to it?",
    diagram: "/diagrams/fpm-approach-example.svg",
    options: ["ATIS is available", "The frequency is pilot-controlled lighting only", "The tower operates only part-time", "Radar service is available"],
    answer: 2,
    explain:
      "A star next to a frequency box is a standard way of flagging that the associated service -- here, the tower -- only operates part-time, with the actual hours given elsewhere (typically in the aerodrome's text entry rather than on the chart itself).",
    reference: "Flight Planning - Chart Symbology & Notes",
  },
  {
    id: 88,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "Still on the same approach chart, what type of approach lighting is noted for runway 09?",
    diagram: "/diagrams/fpm-approach-example.svg",
    options: ["HIALS", "Standard ALSF II", "SALS", "HIALS Calvert I"],
    answer: 2,
    explain:
      "The chart's lighting note for runway 09 reads SALS (Simple Approach Lighting System) -- a basic, shorter-range lighting layout, distinct from the higher-intensity ALSF/Calvert-style systems used to support lower-visibility approaches.",
    reference: "Flight Planning - Approach Lighting Systems",
  },
  {
    id: 89,
    subject: "ATPL General Knowledge",
    system: "Navigation & Flight Planning",
    q: "An aircraft in approach category C is planning an ILS approach. Its normal approach capability is CAT II, but a technical fault has downgraded the aircraft to CAT I for this approach; there is no downgrade to the airport or its ground aids. Given lowest-usable-RVR values of 550 m for CAT I, 300 m for CAT II and 200 m for CAT III (category C), what is the lowest RVR the crew may use to commence the approach?",
    options: ["A meteorological visibility of 550 m", "An RVR of 300 m", "An RVR of 200 m", "An RVR of 550 m"],
    answer: 3,
    explain:
      "Because the aircraft's own capability -- not the airport's -- has been downgraded to CAT I, it may only use the CAT I minimum of 550 m RVR, even though the ground aids could otherwise support the lower CAT II or CAT III minima. The applicable minimum is always the more restrictive of the aircraft's actual capability and the airport's/aids' capability, and here that's the aircraft.",
    reference: "Flight Planning - Approach Ban & RVR Minima",
  },
];
