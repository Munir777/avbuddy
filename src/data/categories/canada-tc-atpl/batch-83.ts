...
export const CANADA_TC_ATPL_BATCH_83_QUESTIONS: Question[] = [
  {
    ...
    options: [
      "a steady, unchanging visual field with no reference points",
      ...
      "rapid alternation between climbing and descending flight",
      "continuous low-frequency engine vibration transmitted through the airframe",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "Skill, Habit, Experience, and Leadership",
      "Stress, Health, Endurance, and Lifestyle",
  ...
  },
  {
    ...
    options: [
      "angular acceleration in the semicircular canals rather than linear acceleration",
      "a purely auditory disturbance rather than any visual or postural component",
      "a delayed onset that occurs only after the acceleration has already stopped",
  ...
  },
  {
    ...
    options: [
      "it exclusively affects the vestibular system and never the visual system",
      "it only occurs during instrument meteorological conditions, never in visual conditions",
      "the pilot is unaware that a disorientating illusion is occurring and takes no corrective action",
      "it always results in loss of consciousness before any corrective action can be taken",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "permanently increase a pilot's physiological tolerance to hypoxia for future flights",
      ...
      "test the structural pressurization limits of the specific aircraft type flown",
      "certify a pilot's blood type for emergency transfusion purposes",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "cabin pressurization systems cannot function correctly when a crew member has a respiratory infection",
      "a cold reduces the total lung capacity available for supplemental oxygen use at altitude",
      "the medication typically used to treat a cold always causes significant drowsiness regardless of the specific product used",
  ...
  },
  {
    ...
    options: [
      "can only be introduced by the flight crew operating the aircraft on the day of the accident",
      ...
      "are always immediately obvious and are the type of failure most easily identified before an accident occurs",
      "refer exclusively to hardware defects and never to organizational or procedural weaknesses",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "a mechanical or equipment failure rather than any human action",
      "an action that always results in an accident, whereas an error never does",
      ...
      "a mistake made only by an inexperienced or newly qualified pilot",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "a requirement that both pilots leave the flight deck simultaneously to rest in the cabin",
      "an unplanned period during which both pilots inadvertently fall asleep simultaneously",
      "scheduled rest taken exclusively in a dedicated crew bunk located away from the flight deck",
  ...
  },
  {
    ...
    options: [
      ...
      "permanently damage the vestibular system's ability to detect angular acceleration",
      "improve reaction time by increasing overall physiological arousal",
      "eliminate the risk of hypoxia by increasing the rate of respiration",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "an increased tolerance to the physiological effects of hypoxia",
      "fatigue, headache, and reduced concentration, compounding other performance-degrading factors already present in flight",
      "a reduction in the cabin's structural pressurization capability",
      "a permanent decrease in visual acuity that does not resolve with rehydration",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "it is only a concern for flights longer than twelve hours in duration",
      "it permanently reduces the body's ability to metabolize oxygen at altitude",
      "it has no measurable effect on cognitive performance provided the pilot remains adequately hydrated",
  ...
  },
  {
    ...
    options: [
      "perceive fine detail and colour when looking directly at an object in daylight",
      "judge distance using stereoscopic (binocular) depth cues at close range",
      ...
      "read instrument displays and printed charts under bright cockpit lighting",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "pilots at the time lacked sufficient technical training in aircraft systems and handling",
      ...
      "aircraft manufacturers had not yet developed adequate automation to assist pilots",
      "air traffic control procedures were entirely responsible for the majority of accidents during that period",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "have no measurable influence on the body's internal circadian rhythm",
      "apply only to artificial lighting and have no relationship to natural sunlight",
      ...
      "permanently reset the circadian rhythm after a single exposure regardless of timing",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "a mandatory checklist to be read aloud before every takeoff regardless of conditions",
      ...
      "a classification system used exclusively by accident investigators after the fact",
      "a set of codewords used only for communicating with air traffic control during an emergency",
    ],
    answer: 1,
    explain:
