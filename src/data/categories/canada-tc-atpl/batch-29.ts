...
export const CANADA_TC_ATPL_BATCH_29_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "one engine's bleed air to pressurize a hydraulic reservoir on the opposite side of the aircraft, despite a PTU specifically transferring hydraulic power rather than pneumatic bleed air between systems.",
  ...
  },
  {
    ...
    options: [
      ...
      "it is powered exclusively by the battery at all times, with no other possible source of power ever connected to it, despite the essential bus being designed to draw from multiple available sources depending on what remains functioning.",
  ...
  },
  {
    ...
    options: [
      ...
      "relying entirely on tire deflection, with the strut itself playing no role in shock absorption, despite the strut's metered orifice and gas charge doing the great majority of the actual shock-absorbing work.",
  ...
  },
  {
    ...
    options: [
      "control brake application exclusively, with no connection to any other aircraft system or function, despite the switch's air/ground logic signal actually feeding numerous other systems throughout the aircraft.",
  ...
  },
  {
    ...
    options: [
      ...
      "hydraulic fluid to be exchanged with fuel system components, sharing a common reservoir between the two systems, despite fuel and hydraulic fluid never being permitted to mix within a properly functioning aircraft.",
  ...
  },
  {
    ...
    options: [
      ...
      "regulating engine bleed air pressure at its source, rather than regulating anything downstream in the cabin itself, despite the outflow valve being physically located in the cabin structure with no direct control whatsoever over the bleed air source.",
  ...
  },
  {
    ...
    options: [
      ...
      "maintain a fixed blade angle at all times, with RPM allowed to vary freely with engine power and airspeed instead, despite holding constant RPM through varying blade angle being the governor's entire defining purpose.",
  ...
  },
  {
    ...
    options: [
      "a system used exclusively for propeller pitch control, with no role in managing engine fuel flow or power settings, despite FADEC being fundamentally an engine fuel and power control concept rather than a propeller-specific one.",
  ...
  },
  {
    ...
    options: [
      "the spoiler type and the flap type, both of which act on wing airflow rather than on engine exhaust or bypass air, despite neither wing spoilers nor wing flaps having any thrust-reversing function on a turbofan engine at all.",
  ...
  },
  {
    ...
    options: [
      ...
      "being certified for use only while the aircraft is airborne, with ground operation of the APU prohibited entirely, despite ground operation being the single most common way an APU is actually used at the gate.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      ...
      "the generator otherwise produces DC power only, with the constant-speed drive being what converts that DC output into usable AC power, despite a CSD regulating rotational speed rather than performing any DC-to-AC conversion.",
    ],
    answer: 1,
    explain:
