...
export const CANADA_TC_ATPL_BATCH_81_QUESTIONS: Question[] = [
  {
    ...
    options: [
      "are defined entirely by latitude rather than longitude, making the 15-degree longitude relationship irrelevant to real-world time zone boundaries, contrary to normal charting convention.",
      "always follow the theoretical 15-degree meridian lines exactly, with no jurisdiction ever deviating from this strict geometric boundary, contrary to normal charting convention.",
      ...
      "change on a daily basis depending on the season, rather than being fixed boundaries adjusted only occasionally by legislation, regardless of the specific chart, receiver type, or navigation system installed.",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "reaches the pole directly after completing a single, finite, straight segment, in exactly the same manner as a great circle track toward the pole, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "cannot be plotted or defined at all once it crosses 60 degrees of latitude, regardless of the track being flown, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "becomes identical to a great circle track once it passes a certain latitude, with no distinction between the two beyond that point, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
  ...
  },
  {
    ...
    options: [
      ...
      "the lowest altitude that guarantees obstacle clearance along the entire airway segment, making it functionally identical to the MEA, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "the highest altitude at which the fix may be used, above which the NAVAID signals defining it are considered unreliable, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "an altitude relevant only to VFR flight, with no application to any IFR fix or airway segment, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "apply only to horizontal position accuracy, with no equivalent measure available for vertical accuracy, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, an assumption inconsistent with standard air navigation theory and charting convention.",
      ...
      "measure the physical distance between the receiver and each individual satellite, rather than describing any effect of satellite geometry, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, contrary to normal charting convention.",
      "are entirely unrelated to satellite geometry, instead measuring atmospheric conditions such as ionospheric activity, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "three interchangeable designators for the exact same type of airspace, with no functional difference between them, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "airspace reserved exclusively for the three different classes of Canadian civil airport (major, regional, and local), a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      ...
      "designators used only for temporary flight restrictions, with no application to any permanently established special use airspace, a description not supported by the applicable navigation reference material or standard practice.",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "four is simply an arbitrary regulatory minimum with no underlying mathematical basis related to the receiver's clock or the position calculation, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      "three satellites are always sufficient for a full three-dimensional fix, with the fourth satellite used solely to check integrity through RAIM, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      "each satellite can only provide information about one of the three position dimensions, requiring three satellites for position alone, plus a fourth for redundancy only, regardless of the specific chart, receiver type, or navigation system installed.",
  ...
  },
  {
    ...
    options: [
      ...
      "equal magnetic variation between true north and magnetic north, making isogrivs simply another name for isogonic lines, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, contrary to normal charting convention.",
      "equal barometric pressure, serving the same charting function as an isobar on a weather chart, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "equal magnetic dip (inclination), making isogrivs simply another name for isoclinic lines, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, regardless of the specific chart, receiver type, or navigation system installed.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "it is the only projection capable of accurately depicting a rhumb line as a straight line, a property no other projection shares, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, contrary to normal charting convention.",
      ...
      "it preserves both true shape and true area simultaneously across the entire chart, a combination no other projection can achieve, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "it is used exclusively for depicting airport diagrams and ground taxi charts, with no application to en route navigation, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "has no defined relationship to UTC at all, making any conversion between the two impossible, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, an assumption inconsistent with standard air navigation theory and charting convention.",
      "runs slower than UTC by a continuously increasing amount, rather than differing by a fixed, known number of whole seconds, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      ...
      "is adjusted for leap seconds in exactly the same way as UTC, meaning the two time scales remain perfectly identical at all times, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, contrary to normal charting convention.",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "show variations in magnetic variation across the chart, serving the same function as isogonic lines, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      "indicate different classes of controlled airspace, replacing the need for any separate airspace boundary symbology, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      "distinguish controlled aerodromes from uncontrolled aerodromes through colour alone, with no other symbol required, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
  ...
  },
  {
    ...
    options: [
      ...
      "a checkpoint usable only during specific hours of the day, unlike a VOT, which operates continuously, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "a facility that broadcasts a dedicated test signal in the same manner as a VOT, differing from a VOT only in its physical location, a claim inconsistent with how this quantity or reference is actually computed by pilots and navigators.",
      "a second, independent VOR receiver installed solely for the purpose of cross-checking the primary receiver, with no reference to any external ground point, contrary to normal charting convention.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "encode the waypoint's exact latitude and longitude directly within the letters themselves, allowing position to be derived purely by reading the identifier, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      ...
      "indicate the waypoint's required minimum altitude, with each letter corresponding to a specific altitude value, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "replace the need for any navigation database to store waypoint coordinates, since the identifier alone is sufficient for RNAV guidance, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "the geoid and the ellipsoid are simply two different names describing the exact same, perfectly smooth shape, with no distinction between them, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      "the ellipsoid model is used only for oceanic navigation, with the geoid used exclusively for all overland aeronautical navigation instead, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      ...
      "WGS84 uses the geoid exclusively and makes no use of any ellipsoid approximation at all, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "requires no reference to the aircraft's heading at all to determine magnetic bearing to the station, unlike a rotatable-card version, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      "automatically displays magnetic bearing to the station directly, with no calculation required by the pilot, in exactly the same manner as a rotatable-card version, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
      "can only be used with an NDB station, while a rotatable-card version can only be used with a VOR station, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, which overlooks the geometric or procedural considerations that actually govern this navigation concept.",
  ...
  },
  {
    ...
    options: [
      ...
      "an outdated variation value has no operational consequence, since GNSS systems have made magnetic variation entirely irrelevant to modern navigation, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "variation values are only ever printed on charts for locations outside Canada, since Canadian charts do not depict magnetic variation at all, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "printed variation values never change over time at any location, meaning a chart's printed value remains accurate indefinitely regardless of its publication date, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, contrary to normal charting convention.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "another name for the WGS84 geodetic datum, with no distinction between the two, a characterization that does not match how this aspect of navigation is actually defined or applied in practice, contrary to normal charting convention.",
      ...
      "a system used exclusively to express altitude, with no application to horizontal position, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
      "a chart projection type, functionally equivalent to the Lambert Conformal Conic projection, a characterization that does not match how this aspect of navigation is actually defined or applied in practice.",
    ],
    answer: 1,
    explain:
