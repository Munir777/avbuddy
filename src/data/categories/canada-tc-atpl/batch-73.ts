...
export const CANADA_TC_ATPL_BATCH_73_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "sees a hand-shaped shadow cast on the clouds by the aircraft, which can be mistaken for another aircraft.",
  ...
  },
  {
    ...
    options: [
      ...
      "always choose the safest possible option available, regardless of any resources already committed.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      ...
      "trust automated systems more than human judgment purely because the automation is electronic rather than human.",
  ...
  },
  {
    ...
    options: [
      "function identically regardless of flight phase, providing a constant, unvarying level of assistance throughout every flight.",
  ...
  },
  {
    ...
    options: [
      ...
      "task-switching cost applies only to physical (motor) tasks and has no effect on purely cognitive tasks such as mental math or memory recall.",
  ...
  },
  {
    ...
    options: [
      ...
      "is required by regulation to be used at all times, with an authoritarian style considered unsafe in every circumstance, including genuine emergencies requiring immediate unilateral action.",
  ...
  },
  {
    ...
    options: [
      "focusing exclusively on the centre of the windscreen directly ahead, since peripheral vision provides no useful information for traffic detection.",
  ...
  },
  {
    ...
    options: [
      ...
      "cosmic radiation exposure is unrelated to altitude or route and depends only on the total number of hours flown, regardless of where those hours are flown.",
  ...
  },
  {
    ...
    options: [
      "increase the occupant's overall body height to improve visibility of emergency exits.",
  ...
  },
  {
    ...
    options: [
      ...
      "affect only long-term health outcomes, with no measurable effect on in-the-moment decision-making during the event itself.",
  ...
  },
  {
    ...
    options: [
      "once a procedure has been learned to proficiency during initial training, it will remain fully reliable indefinitely with no further practice required.",
  ...
  },
  {
    ...
    options: [
      ...
      "automatically restart the entire checklist from the beginning with no risk of error, since interruptions have no measurable effect on checklist accuracy.",
