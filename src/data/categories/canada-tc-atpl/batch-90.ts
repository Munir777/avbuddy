...
export const CANADA_TC_ATPL_BATCH_90_QUESTIONS: Question[] = [
  {
    ...
    options: [
      "physically driving the generator's rotor at a constant mechanical speed, independent of engine N2 or any electrical fault condition",
      "converting DC battery power into AC power for the essential bus, a function instead performed by the static inverter",
      "regulating generator output voltage and frequency, and disconnecting the generator from the bus if a fault, such as overvoltage or underfrequency, is detected",
      "providing hydraulic pressure to the landing gear system, a task performed instead by the hydraulic system pumps",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "present only on turboprop engines, never on a turbofan or turbojet, since those engine types are assumed to instead use a single-spool rotating assembly throughout their entire operating range",
      "connected only during the engine start sequence, then permanently locked together for the remainder of the flight regardless of thrust setting",
      "mechanically connected by a common shaft, forcing them to rotate at a fixed ratio to one another at every power setting",
      "not mechanically connected to each other, each spool free to rotate at its own speed, coupled only aerodynamically through the gas flow passing through the engine core",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    options: [
      "can occur beneath the surface with little or no visible external indication, requiring specialized non-destructive testing to detect reliably",
      "never affects the structural strength of a composite component, regardless of the delamination's size, depth, or location within the laminate layup structure",
      "only occurs in metal structures, never in composite materials, since composite layups are assumed to be immune to internal separation",
      "is always immediately visible on the surface, making inspection simpler than for metal structures with subsurface fatigue cracking",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "has no function related to the landing roll, applying only during taxi at low ground speed",
      "inhibits brake application until the wheels have spun up to an appropriate speed after touchdown, preventing braking before the tires are actually rotating",
      "permanently disables braking for the remainder of the flight after a single skid event, regardless of any subsequent anti-skid system reset or crew action",
      "automatically applies maximum braking the instant the aircraft touches down, regardless of wheel spin-up or tire rotational speed",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "only possible if all engine-driven generators have already failed, with no other circumstance permitting its use in flight",
      "unrestricted at any altitude, with no operational limitation whatsoever on APU generator use during any phase of flight",
      "subject to a maximum operating altitude limitation published in the AFM, above which APU use in flight is not approved",
      "never permitted under any circumstance, since APUs are certified for ground use only and have no defined in-flight operating envelope at all",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "represent a single, identical thrust value that never changes regardless of the phase of flight or the ambient temperature",
      "apply only to piston engines, never to turbine engines, since turbine thrust is instead limited solely by N1 and EGT",
      "eliminate the need for any other engine operating limitation, such as N1 or EGT limits, during any phase of flight",
      "define the maximum thrust permitted for specific phases of flight, each with an associated time limitation appropriate to that phase",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    options: [
      "underinflation can cause excessive flexing and heat buildup, while overinflation can reduce the tire's contact patch and increase susceptibility to cuts from surface irregularities",
      "only overinflation presents any risk at all, since underinflated tires are always considered inherently safer under any operating condition",
      "tire pressure is relevant only to ground handling ease, with no safety implication for tire temperature, structural integrity, or susceptibility to damage during either taxi or flight",
      "tire pressure has no relationship to tire temperature, wear, or structural integrity, regardless of the surface or loading conditions encountered",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "convert AC generator output into DC power for charging the battery, performing the same function as a TRU during normal operation",
      "convert available DC battery power into a limited AC supply, providing essential AC-powered equipment with power during a loss of normal AC generation",
      "mechanically drive the RAT's hydraulic pump, a function unrelated to the aircraft's AC or DC electrical distribution",
      "permanently replace the need for any battery on the aircraft, since it is assumed to generate its own DC power independently under all operating conditions",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "shuts down the entire electrical system to prevent further faults, regardless of which equipment remains essential to continued safe flight operations",
      "applies only on the ground, never during flight, since load shedding logic is assumed to be inactive once airborne",
      "automatically disconnects selected non-essential electrical loads, preserving capacity for essential and higher-priority equipment",
      "has no defined logic, relying entirely on the crew to manually select which equipment to power after any generator loss",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "low tire pressure, with no relation to fire or heat at all, a parameter instead monitored by a separate tire pressure indicating system",
      "a fire occurring exclusively in the passenger cabin, a condition instead detected by the separate smoke detectors installed in the lavatories and cabin ceiling",
      "a fault in the aircraft's weather radar system, unrelated to any thermal condition within the landing gear bay",
      "a fire or overheat condition specifically within the landing gear bay, such as from an overheated brake or a hydraulic fluid fire",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    options: [
      "the panels on both wings are mechanically interconnected and driven in a synchronized manner from a single power source, helping ensure symmetric deployment across both wings",
      "flap and slat deployment speed is unrelated to the drive shaft's rotational speed, since deployment is instead timed electronically",
      "the system can operate without any electrical or hydraulic power source at all, relying solely on aerodynamic loads to move the panels",
      "each flap or slat panel can be driven completely independently, with no mechanical relationship to any other panel on either wing",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "permanently lock the nose wheel in a fixed position during flight, preventing any future extension or normal gear operation for the remainder of that flight",
      "automatically align the nose wheel straight ahead as the gear retracts, so it fits properly within the confines of the wheel well",
      "automatically steer the nose wheel during taxi in place of the pilot's steering input, overriding the tiller at low speed",
      "increase nose wheel steering sensitivity at high taxi speeds, independent of the gear's retraction or extension cycle",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "provide the primary structural strength connection at that joint, replacing the need for mechanical fasteners such as bolts or rivets",
      "insulate the two sides of the joint electrically from one another, preventing any current from crossing the joint",
      "provide a low-resistance electrical path across the joint, helping safely conduct lightning current or static charge and reducing arcing risk",
      "exist only on composite aircraft, never on aluminum airframes, since metal structure is assumed to already be sufficiently conductive without any added bonding strap at all",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "increase fuel pressure well beyond the boost pump's normal output, regardless of the condition of the filter element",
      "permanently block fuel flow entirely if the filter becomes clogged, protecting the engine from any contamination regardless of the resulting risk of fuel starvation",
      "convert fuel from a liquid to a vapour state before reaching the engine, a process unrelated to filter condition or pressure differential",
      "allow fuel to continue flowing to the engine, bypassing a clogged filter element, if the pressure differential across the filter becomes excessive",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    options: [
      "assess the remaining serviceable life of the brake friction material without needing to fully disassemble the brake",
      "measure hydraulic fluid quantity in the brake system reservoir, without needing to open an inspection panel",
      "determine tire pressure without a separate gauge, inferring it instead from how far the wear pin has receded into the brake housing",
      "directly measure brake temperature during a landing rollout, without any reference to the friction material's remaining thickness",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      "serves no structural purpose, being purely a cosmetic panel with no role in withstanding cabin pressurization loads",
      "is specifically designed to withstand the pressurization load across the boundary between the pressurized cabin and the unpressurized section beyond it",
      "is found only on unpressurized aircraft, since a pressurized fuselage is assumed to require no dedicated pressure-bearing structure",
      "is identical in design and loading to every other frame along the fuselage, regardless of its position relative to the pressurized section",
    ],
    answer: 1,
    explain:
