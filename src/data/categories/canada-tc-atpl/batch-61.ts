...
export const CANADA_TC_ATPL_BATCH_61_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      "the loop antenna alone produces a figure-eight reception pattern that is ambiguous between two opposite bearings 180 degrees apart, and combining it with the sense antenna's signal produces a single cardioid pattern that resolves which of the two bearings is correct.",
      ...
      "combining the two antennas is done purely to boost signal strength, with no effect whatsoever on bearing accuracy or ambiguity.",
  ...
  },
  {
    ...
    options: [
      "turning error occurs identically on headings through east and west, with no effect at all when turning through north or south.",
      "as the aircraft banks during a turn, the compass card is displaced by the vertical component of the Earth's magnetic field (magnetic dip) acting on the tilted compass assembly, causing the indicated heading to lag when turning through north and lead when turning through south.",
  ...
  },
  {
    ...
    options: [
      ...
      "accelerating on an easterly or westerly heading causes the compass to indicate a turn toward north, while decelerating causes it to indicate a turn toward south, even though the aircraft's actual heading has not changed.",
      "acceleration error occurs only while turning, never during straight and level flight on a constant heading.",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      "convert true heading directly to compass heading in a single step, skipping the magnetic heading stage entirely.",
      ...
      "look up the deviation correction applicable for a given magnetic heading (often listed for headings in 30-degree increments), which is then applied to convert a magnetic heading to the compass heading the pilot should actually fly.",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    options: [
      "LMT is based on the mean sun's position directly over that specific meridian, changing continuously with longitude, while Standard Time is a single, fixed offset from UTC applied uniformly across an entire time zone regardless of the exact longitude within it.",
      ...
      "Standard Time changes continuously with exact longitude, while LMT is fixed uniformly across an entire time zone.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      ...
      "slant range error applies only to VOR bearing measurements, with no relevance whatsoever to DME distance readings.",
      "DME measures the direct, straight-line (slant) distance from the aircraft to the station rather than the horizontal (ground track) distance, so the indicated distance is slightly greater than the true horizontal distance, an effect most significant when the aircraft is close to or directly over the station at altitude.",
  ...
  },
  {
    ...
    options: [
      ...
      "can detect a satellite fault but, unlike RAIM, has no ability to alert the pilot to the fault's presence at all.",
      "not only detects that a satellite's signal is likely faulty (as RAIM does) but also identifies and excludes that specific faulty satellite from the position solution, allowing navigation to continue using the remaining healthy satellites without interruption.",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    options: [
      "IFR traffic is generally separated from MOA activity by ATC, while VFR pilots may fly through an active MOA but should exercise increased vigilance for high-speed or unusual military manoeuvring traffic, since VFR flight is not itself prohibited there.",
      ...
      "flight through a MOA is prohibited for all aircraft, civilian and military alike, at all times without exception.",
  ...
  },
  {
    ...
    options: [
      ...
      "toward or away from the station, based on the aircraft's actual position relative to the selected course line, regardless of which direction the aircraft's nose is currently pointed.",
      "above or below the VOR station's published minimum reception altitude.",
      "toward or away from the destination aerodrome, regardless of which VOR station or course is currently selected.",
    ],
    answer: 1,
    explain:
  ...
  },
  {
    ...
    options: [
      "a term applying only to rhumb line tracks, with no equivalent concept for a great circle track.",
      "the midpoint of the route measured strictly by distance along the track, unrelated to latitude.",
      "the point along that great circle track at which the track reaches its highest (or, on the opposite side of the Earth, lowest) latitude, where the track is momentarily oriented due east-west.",
  ...
  },
  {
    ...
    options: [
      ...
      "the elevation of the single highest-elevation aerodrome located within that quadrangle.",
      "the height of the highest known terrain or obstacle within that quadrangle, rounded up and including a vertical buffer, giving a pilot a quick reference for a safe altitude to clear all known hazards in that area.",
    ],
    answer: 3,
    explain:
  ...
  },
  {
    ...
    options: [
      "the aircraft's navigation system must be able to keep the aircraft within that stated number of nautical miles of the centreline for a defined high percentage of flight time, with onboard performance monitoring and alerting if that containment cannot be assured.",
      "the value applies exclusively to vertical (altitude) accuracy, with no lateral containment component whatsoever.",
