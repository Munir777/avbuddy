...
export const CANADA_TC_ATPL_BATCH_28_QUESTIONS: Question[] = [
  {
    ...
    options: [
      "TODA is always shorter than TORA, since TODA excludes any usable clearway beyond the physical runway, even though clearway is specifically credited toward extending the distance available for the initial climb-out after becoming airborne.",
  ...
  },
  {
    ...
    options: [
      "extend the physical runway surface itself, functioning identically to simply lengthening the paved runway, even though a clearway is not required to be load-bearing or paved to any runway-surface standard at all.",
  ...
  },
  {
    ...
    options: [
      ...
      "an area used exclusively for aircraft taxiing, unrelated to either takeoff distance or accelerate-stop distance calculations, despite a stopway specifically being credited toward accelerate-stop distance available.",
  ...
  },
  {
    ...
    options: [
      "elevation has no effect on takeoff performance at all, so the entire 'hot and high' penalty is attributable to temperature alone, despite elevation independently reducing air density and engine performance regardless of temperature.",
  ...
  },
  {
    ...
    options: [
      ...
      "a value that applies only to landing, with no equivalent consideration or published value for takeoff, even though crosswind capability is just as operationally relevant during the takeoff roll itself.",
  ...
  },
  {
    ...
    options: [
      "affects only the landing roll, with takeoff ground roll considered entirely unaffected by any tailwind component, despite groundspeed at a given airspeed being higher during takeoff as well.",
  ...
  },
  {
    ...
    options: [
      ...
      "a fixed value identical for every departure procedure at every aerodrome, regardless of surrounding terrain or obstacles, even though the required gradient is calculated from the obstacles along each individual path.",
    ],
    answer: 2,
    explain:
  ...
  },
  {
    ...
    options: [
      ...
      "lower minima than a straight-in approach, since circling is considered a more precise and less demanding manoeuvre than flying straight in, despite the additional visual manoeuvring workload circling actually involves near the airport.",
  ...
  },
  {
    ...
    options: [
      "no defined minimum altitude at all, since non-precision approaches by definition carry no published minima, despite every published non-precision approach specifying a minimum descent altitude that must never be descended below without visual reference.",
  ...
  },
  {
    ...
    options: [
      "eliminating the concept of an MDA entirely, converting every non-precision approach into a precision approach with a DA/DH, despite CDFA remaining a technique flown on an approach that still publishes an MDA rather than a DA/DH.",
  ...
  },
  {
    ...
    options: [
      "verify that landing distance required, using the actual conditions expected at arrival -- weight, wind, runway condition, and configuration -- still fits within landing distance available.",
      ...
      "apply only to VFR flights, with IFR flights considered exempt from any in-flight landing distance reassessment requirement, despite IFR operations typically being exactly where such a policy is applied most consistently.",
    ],
    answer: 0,
    explain:
  ...
  },
  {
    ...
    options: [
      ...
      "serve as additional usable runway length for takeoff, functioning identically to an extension of TORA, despite a RESA specifically being excluded from any takeoff or accelerate-stop distance calculation.",
    ],
    answer: 1,
    explain:
