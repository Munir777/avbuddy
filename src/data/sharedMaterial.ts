  ...
  "Qatar Airways": [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "A third candidate's panel was slightly different in composition — one HR representative and two training captains, a Boeing TRI and an Airbus TRI — but the exercise itself followed the same shape: introduce yourself, then work through a flight plan, this time for a Bangkok–Doha sector. The weather on that flight plan was genuinely marginal — thunderstorms and towering cumulus in the area, visibility down to 7 km, QNH 1010, and rain — so this wasn't just an abstract chart-reading exercise; the panel also included a significant weather chart and asked about specific symbols on it, so it's worth being comfortable reading a SIGWX chart cold rather than just knowing the concepts in the abstract.\n\n" +
